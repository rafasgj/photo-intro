    ...
    \begin{columns}
        ...
        \column{0.65\textwidth}{
            \begin{itemize}
                ...
                \item Os resultados tendem a ser mais intensos que o ajuuste de
                branco global.
            \end{itemize}
        }
    \end{columns}
    ...
    \begin{columns}
        ...
        \column{0.65\textwidth}{
            \begin{itemize}
                ...
                padrões de alta freqüência. Verifique em 100\% \textbf{antes} de aplicar
                o efeito.
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.65\textwidth}{
            \begin{itemize}
                \item Define a aplicação da mascara de ajuste local apenas em uma
                faixa de cromaticiades específica.
    ...
    \begin{columns}
        ...
        \column{0.65\textwidth}{
            \begin{itemize}
                ...
                ou \textbf{Instantâneo}, para fazer outra versão da imgem.
    ...
    \begin{columns}
        ...
        \column{0.65\textwidth}{
            \begin{itemize}
                ...
                da última foto ajustada à foto autual.
                \item O botão \textbf{Redefinir} (\textit{Reset}) zera todas as configurações,
                trazendo a imagem ao estado da cofiguração \textit{default}.
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.65\textwidth}{
            Existem quatro modos de vizualização:
            \begin{itemize}
